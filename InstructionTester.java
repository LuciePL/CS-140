...
*/
	...
	/**
	 * Tests whether ROT throws an exception when given an indirect argument
	 */
	@Test (expected=IllegalArgumentException.class)
	...
	/**
	 * Tests whether ROT throws an exception when given an immediate argument
	 */
	
	@Test (expected=IllegalArgumentException.class)
	public void testROTImmediate() {
		Instruction instr = machine.get(0X14);
		instr.execute(0, 0);
	}
	
	/**
	 * Tests if ROT works if given a negative number for "move"
	 */
	
	@Test
	public void testROTNeg(){
		Instruction instr = machine.get(0X14);
		machine.setData(12, 207);
		machine.setData(13, 58);
		machine.setData(14, -3);
		machine.setData(207, 121);
		machine.setData(208, 112);
		machine.setData(209, 170);
		machine.setData(210, 719);
		machine.setData(211, 1254);
		machine.setData(212, 6092);
		machine.setData(260, 33);
		machine.setData(261, 96);
		machine.setData(262, 900);
		machine.setData(263, 203);
		machine.setData(264, 2);
		instr.execute(12, 1);
		assertEquals(719, machine.getData(207));
		assertEquals(1254, machine.getData(208));
		assertEquals(6092, machine.getData(209));
		assertEquals(203, machine.getData(260));
		assertEquals(2, machine.getData(261));
		assertEquals(121, machine.getData(262));
		assertEquals(112, machine.getData(263));
		assertEquals(170, machine.getData(264));
	}
	
	/**
	 * Tests if ROT works if given a positive number for "move"
	 */
	
	@Test
	public void testROTPos(){
		Instruction instr = machine.get(0X14);
		machine.setData(12, 207);
		machine.setData(13, 58);
		machine.setData(14, 3);
		...
		machine.setData(264, 2);
		instr.execute(12, 1);
		assertEquals(121, machine.getData(210));
		assertEquals(112, machine.getData(211));
		assertEquals(170, machine.getData(212));
		assertEquals(719, machine.getData(213));
		assertEquals(1254, machine.getData(214));
		assertEquals(6092, machine.getData(215));
		assertEquals(33, machine.getData(263));
		assertEquals(96, machine.getData(264));
		assertEquals(900, machine.getData(207));
		assertEquals(203, machine.getData(208));
		assertEquals(2, machine.getData(209));
	}
}